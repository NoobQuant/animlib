...
def WriteScatter(df, path, varname, x, y):
        """
        Write scatter data from pandas dataframe to json object to be used in
        scatter plots in animlib. Dataframe needs to have columun x, y, "color",
        and "r".
        """
        json = '['
        #counter = 0
